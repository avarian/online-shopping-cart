...
type Account struct {
	...
	Type        string          `json:"type" gorm:"size:255;default:CUSTOMER"`
	...
	Cart *Cart `json:"cart,omitempty" gorm:"constraint:OnUpdate:CASCADE,OnDelete:RESTRICT;foreignKey:AccountID;references:ID"`
}
